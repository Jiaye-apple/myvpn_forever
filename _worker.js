...
<body>
    ...
    <div class="container">
        ...
        <div class="hero-section fade-in">
            <h1 class="name-title">林家业</h1>
            <p class="subtitle">星火黑科技研究院创始人 · CEO 兼院长</p>
        </div>
        ...
        <div class="content-section">
            ...
            <div class="info-card fade-in">
                ...
                <div class="info-item">
                    <span class="highlight">华南师范大学</span> 学者
                </div>
                <div class="info-item">
                    <span class="highlight">中国教育学会</span> 会员
                </div>
                <div class="info-item">
                    <span class="highlight">中国计算机学会</span> 会员
                </div>
                <div class="info-item">
                    硬笔书法 <span class="highlight">七级</span> 认证
                </div>
            </div>

            <!-- 职业成就 -->
            <div class="info-card fade-in">
                <h2 class="card-title">职业成就</h2>
                <div class="info-item">
                    <span class="highlight">星火黑科技研究院</span> 创始人
                </div>
                <div class="info-item">
                    研究院 <span class="highlight">CEO 兼院长</span>
                </div>
                <div class="info-item">
                    多个 <span class="highlight">国家级权威期刊</span> 发表文章
                </div>
                <div class="info-item">
                    获得 <span class="highlight">多项专业奖项</span>
                </div>
            </div>
        </div>
        ...
        <div class="achievements fade-in">
            <h2 class="card-title" style="text-align: center; font-size: 2.2rem;">专业领域</h2>
            <div class="achievements-grid">
                <div class="achievement-item fade-in">
                    <span class="achievement-icon">🎓</span>
                    <h3 class="achievement-title">教育研究</h3>
                    <p class="achievement-desc">华南师范大学学术背景，中国教育学会会员，专注教育创新研究</p>
                </div>
                <div class="achievement-item fade-in">
                    <span class="achievement-icon">💻</span>
                    <h3 class="achievement-title">计算机科学</h3>
                    <p class="achievement-desc">中国计算机学会会员，在前沿技术领域具有深厚造诣</p>
                </div>
                <div class="achievement-item fade-in">
                    <span class="achievement-icon">🚀</span>
                    <h3 class="achievement-title">科技创新</h3>
                    <p class="achievement-desc">星火黑科技研究院创始人，引领未来科技发展方向</p>
                </div>
                <div class="achievement-item fade-in">
                    <span class="achievement-icon">✍️</span>
                    <h3 class="achievement-title">书法艺术</h3>
                    <p class="achievement-desc">硬笔书法七级认证，将传统文化与现代科技完美结合</p>
                </div>
            </div>
        </div>
    </div>
